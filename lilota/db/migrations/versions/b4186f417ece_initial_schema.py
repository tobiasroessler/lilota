...
def upgrade() -> None:
    ...
    op.create_index('idx_retryable_tasks', 'lilota_task', ['retried_at', 'status', 'run_at'], unique=False)
    op.create_index(op.f('ix_lilota_task_retried_at'), 'lilota_task', ['retried_at'], unique=False)
